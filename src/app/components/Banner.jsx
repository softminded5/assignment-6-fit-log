...
const Banner = () => {
    return (
        <div className='p-4'>
            <div className="mx-auto flex max-w-7xl flex-col items-center overflow-hidden rounded-2xl border border-[#252830] bg-[#262d3de2] shadow-lg shadow-black/20 px-6 py-8 sm:px-10 lg:min-h-81.25 lg:flex-row lg:px-12">
            ...
            <div className="mt-6 flex justify-center lg:mt-0 lg:flex-1 lg:justify-end">
                ...
                className="w-70 object-contain xl:w-82.5"
                />
            </div>
        </div>
        </div>
